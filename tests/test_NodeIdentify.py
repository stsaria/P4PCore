...
class TestNodeIdentify:
    def testCreate(self):
        ...
        pubKey = HashableEd25519PublicKey(privateKey.public_key().public_bytes_raw())
    ...
    def testInequality(self):
        ...
        pubKey1 = HashableEd25519PublicKey(privateKey1.public_key().public_bytes_raw())
        pubKey2 = HashableEd25519PublicKey(privateKey2.public_key().public_bytes_raw())
